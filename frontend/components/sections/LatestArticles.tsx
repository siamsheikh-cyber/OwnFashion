    ...
    <section className="px-[20px] md:px-[80px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-[32px]">
        ...
        <article className="md:col-span-7 group flex flex-col cursor-pointer">
          <Link href="/posts/the-return-to-maximalist-outerwear" className="flex flex-col h-full">
          ...
          {featuredArticles.map((article, i) => (
            <div key={article.title}>
              ...
              <article className="group cursor-pointer">
                <Link href={`/posts/${article.slug || 'investing-in-timeless-hardware'}`} className="grid grid-cols-5 gap-6 items-center">
