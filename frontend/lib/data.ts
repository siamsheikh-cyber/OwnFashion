...
export const carouselProducts: CarouselProduct[] = [
  ...
  },
  {
    ...
    quote: 'Crisp organic cotton that stays wrinkle-free. The quintessential wardrobe foundation.',
    details: ['100% Crisp Poplin Cotton', 'Dropped shoulder seam', 'Chest patch pocket'],
  },
  {
    name: 'Pleated Wide-Leg Palazzo Pants',
    price: '$75 Under',
    badge: 'Top Rated',
    rating: 4.5,
    reviews: '(1.6k reviews)',
    image: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?auto=format&fit=crop&w=900&q=80',
    quote: 'Fluid movement and immaculate front pleats. Elegant enough for day-to-night styling.',
    details: ['Flowing crepe fabric', 'High rise with belt loops', 'Deep trouser pockets'],
  },
];
